...
public sealed class GuardianHostService : IAsyncDisposable
{
    ...
    private readonly NativeRadioAccess _nativeRadio;
        ...
        InMemoryLogSink logSink)
    {
        ...
        _nativeRadio = new NativeRadioAccess(loggerFactory.CreateLogger<NativeRadioAccess>());
        _radio = new WifiRadioController(loggerFactory.CreateLogger<WifiRadioController>())
        {
            NativeFallback = _nativeRadio,
        };
